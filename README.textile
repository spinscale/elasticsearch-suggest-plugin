...
<pre><code>bin/plugin -install de.spinscale/elasticsearch-plugin-suggest/0.20.2-0.4</code></pre>
...
* David for pushing me to get it into the maven repo
