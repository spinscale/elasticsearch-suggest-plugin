...
<pre><code>bin/plugin -url https://github.com/downloads/spinscale/elasticsearch-suggest-plugin/elasticsearch-plugin-suggest-0.19.11-0.1-SNAPSHOT.zip -install suggest</code></pre>
