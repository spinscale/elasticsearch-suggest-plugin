...
<pre><code>bin/plugin -url https://github.com/downloads/spinscale/elasticsearch-suggest-plugin/elasticsearch-plugin-suggest-0.19.12-0.2.zip -install suggest</code></pre>
If you want to use the last version, enter (might not work as it is work in progress)
<pre><code>bin/plugin -install spinscale/elasticsearch-suggest-plugin</code></pre>
