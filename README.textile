...
<pre><code>bin/plugin -url https://github.com/downloads/spinscale/elasticsearch-suggest-plugin/elasticsearch-suggest-0.0.3-0.18.6.zip -install suggest</code></pre>
...
* Ensure that the _all field can be suggested on as well, see https://github.com/spinscale/elasticsearch-suggest-plugin/issues/1
* Check https://github.com/elasticsearch/elasticsearch/issues/1612 and https://github.com/elasticsearch/elasticsearch/issues/1613
...
* Allow clearing of fst suggesters at least per index
